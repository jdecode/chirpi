...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    <head>
        ...
        <link rel="shortcut icon" href="{{ asset('chirpi.png') }}" type="image/png">
    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="fixed top-0 right-0 text-right flex-col space-y-2 p-6">
                @if (Route::has('login'))
                    <div class="">
                        @auth
                ...
                @if (Route::has('client.login'))
                    <div class="">
                        <div class="">
                            @auth('client')
                                <a href="{{ url(route('client.dashboard')) }}"
                                   class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Client
                                    Dashboard</a>
                            @else
